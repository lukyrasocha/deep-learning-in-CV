...
### ------------ specify job name ------------------
#BSUB -J ph2_unet_no_padding_weighted_bce
...
python ~/02516-intro-to-dl-in-cv/poster-2-segmentation/main.py --model unet --data ph2 --loss_fn weighted_bce --epochs 1500 --padding 0 --jobid $LSB_JOBID --visualize