...
### ------------ specify job name ------------------
#BSUB -J drive_unet_with_padding_focal
...
python ~/02516-intro-to-dl-in-cv/poster-2-segmentation/main.py --model unet --data drive --loss_fn focal --epochs 1500 --padding 1 --jobid $LSB_JOBID --visualize