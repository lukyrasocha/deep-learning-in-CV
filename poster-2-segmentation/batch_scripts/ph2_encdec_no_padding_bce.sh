...
### ------------ specify job name ------------------
#BSUB -J ph2_encdec_no_padding_bce
...
python ~/02516-intro-to-dl-in-cv/poster-2-segmentation/main.py --model encdec --data ph2 --loss_fn bce --epochs 1500 --padding 0 --jobid $LSB_JOBID --visualize