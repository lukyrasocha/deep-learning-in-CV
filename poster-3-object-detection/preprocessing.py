...
if __name__ == '__main__':
    ...
    save_images_in_folder_relative = '/dtu/blackhole/17/209207/training_data/images'
    save_targets_in_folder_relative = '/dtu/blackhole/17/209207/training_data/targets'

    # save paths for validation
    save_targets_in_folder_relative_val = '/dtu/blackhole/17/209207/validation_data/targets' #'Potholes/validation_data/targets'

    # save paths for test
    save_targets_in_folder_relative_test = '/dtu/blackhole/17/209207/test_data/targets' # 'Potholes/test_data/targets'
